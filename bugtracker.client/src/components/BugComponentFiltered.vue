          ...
          <div class="card text-dark">
            <div class="card-header">
              <h5 class="card-title">
                ...
                <span>{{ bugProp.title }}</span>
              <!-- TODO {{ bugProp.title }} -->
              </h5>
            </div>
            <div class="card-body">
              <p class="card-subtitle mb-2 text-muted">
                <span>Reported by: </span><b>{{ bugProp.creator.name }}</b>
              ...
              <p class="card-text">
                <span>Last updated: </span><b>{{ bugProp.updatedAt.split('T')[0] }}</b>
...
.bottom-line2{
  border-bottom: solid;
  border-bottom-color: gray(121, 121, 121);
